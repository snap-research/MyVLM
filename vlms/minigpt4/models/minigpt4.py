...
from vlms.minigpt4.models.base_model import disabled_train
from vlms.minigpt4.models.minigpt_base import MiniGPTBase
from vlms.minigpt4.models.Qformer import BertConfig, BertLMHeadModel
...
class MiniGPT4(MiniGPTBase):
    ...
    def __init__(
        ...
        if prompt_path:
            ...
            print('Load {} concept_embedding_training prompts'.format(len(self.prompt_list)))
